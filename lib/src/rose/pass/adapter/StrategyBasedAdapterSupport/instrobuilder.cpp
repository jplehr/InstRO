...
SgDeclarationStatement *InstROBuilder::buildFunctionDeclaration(SgScopeStatement *scope, std::string functionName) {
  ...
  SgFunctionDeclaration *enterFunction = SageBuilder::buildNondefiningFunctionDeclaration(
      functionName, SageBuilder::buildVoidType(), functionParameterList, scope);
...
SgExprStatement *InstROBuilder::buildFunctionCall(SgScopeStatement *scope, SgExpression *firstArgument,
                                                  SgExpression *secondArgument, std::string functionName) {
  ...
  return SageBuilder::buildFunctionCallStmt(functionName, SageBuilder::buildVoidType(), argument_expression_list_enter,
