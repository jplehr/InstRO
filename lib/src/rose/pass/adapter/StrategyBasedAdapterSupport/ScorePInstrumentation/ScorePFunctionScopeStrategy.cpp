...
std::vector<SgStatement *> ScorePFunctionScopeStrategy::constructEntryInstrumentationInsideNthScopeFor(
...
std::vector<SgStatement *> ScorePFunctionScopeStrategy::constructExitInstrumentationInsideNthScopeFor(
    SgScopeStatement *node, size_t index) {
  std::vector<SgStatement *> result;
