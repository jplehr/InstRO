...
CodeInsertionHelper::CodeInsertionHelper() { assert(false); }
...
CodeInsertionHelper::CodeInsertionHelper(const CodeInsertionHelper &other) : currentAnchors(other.currentAnchors) {}
