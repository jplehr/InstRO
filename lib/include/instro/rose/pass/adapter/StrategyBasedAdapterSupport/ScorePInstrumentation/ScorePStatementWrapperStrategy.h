#ifndef INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_SCOREPINSTRUMENTATION_SCORE_P_STATEMENT_WRAPPER_STRATEGY_H__
#define INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_SCOREPINSTRUMENTATION_SCORE_P_STATEMENT_WRAPPER_STRATEGY_H__
...
class ScorePStatementWrapperStrategy : public GenericInstrumentationStrategy {
 public:
  ScorePStatementWrapperStrategy(std::shared_ptr<ToolInitializer> toolInitializerStrategy);
