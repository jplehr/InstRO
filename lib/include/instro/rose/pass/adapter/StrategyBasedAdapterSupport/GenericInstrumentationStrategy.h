...
class GenericInstrumentationStrategy {
 ...
 protected:
  ...
  virtual std::vector<SgStatement *> constructEntryInstrumentationInsideNthScopeFor(SgScopeStatement *node,
                                                                                    size_t scopeIndex = 0);
  ...
  virtual std::vector<SgStatement *> constructExitInstrumentationInsideNthScopeFor(SgScopeStatement *node,
                                                                                   size_t scopeIndex = 0);
