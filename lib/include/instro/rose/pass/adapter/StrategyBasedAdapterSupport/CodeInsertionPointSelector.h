#ifndef INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_CODE_INSERTION_POINT_SELECTOR_H__
#define INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_CODE_INSERTION_POINT_SELECTOR_H__
