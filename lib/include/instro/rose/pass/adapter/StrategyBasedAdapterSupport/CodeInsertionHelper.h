#ifndef INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_CODE_INSERTION_HELPER_H__
#define INSTRO_ROSE_PASS_ADAPTER_STRATEGYBASEDADAPTER_CODE_INSERTION_HELPER_H__
...
class CodeInsertionHelper {
 public:
   ...
   */
  enum RelativePosition { prepend, append, before, after };
