...
/// function.
///
/// Used by both the InstRO::Rose::Transformer::RoseUniqueCallpathTransformer and the
/// InstRO::Rose::Transformer::RoseFunctionWrapper. \author Simon Reuß
class FunctionRenamer {
 public:
  ...
  /// \brief Finds all function call expressions refering to the target function in the sub-ASTs specified by the
  /// supplied nodes.
  ///
  ...
  ///
  /// #findFunctionCalls should have been called before invoking this method. Otherwise, no function calls will be
  /// redirected!
